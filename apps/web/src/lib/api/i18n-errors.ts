...
const API_ERRORS = {
  tr: {
    ...
    demoWriteBlocked: 'Demo hesaplar değişiklik yapamaz. Bu bir inceleme hesabıdır.',
    ...
    deviceKeyRequired: 'Cihaz API anahtarı gerekli (X-Device-Key veya Authorization: Device).',
    deviceKeyInvalid: 'Geçersiz veya devre dışı cihaz anahtarı.',
    deviceLimitReached: 'Plan cihaz limitine ulaşıldı.',
    deviceNotFound: 'Cihaz bulunamadı.',
    deviceFieldsRequired: 'name ve hardwareId zorunludur.',
    checkInPayloadRequired: 'qrToken, rfidTag veya gymMemberId zorunludur.',
  ...
  en: {
    ...
    demoWriteBlocked: 'Demo accounts cannot make changes. This is a read-only preview account.',
    ...
    deviceKeyRequired: 'Device API key required (X-Device-Key or Authorization: Device).',
    deviceKeyInvalid: 'Invalid or disabled device key.',
    deviceLimitReached: 'Device plan limit reached.',
    deviceNotFound: 'Device not found.',
    deviceFieldsRequired: 'name and hardwareId are required.',
    checkInPayloadRequired: 'qrToken, rfidTag or gymMemberId is required.',
