  ...
  const navGroups = [
    {
      ...
      items: [
        ...
        { href: '/admin/partners', label: tAdmin('partnersNav') },
      ],
    },
    {
      ...
      items: [
        ...
        { href: '/admin/audit?category=security', label: tAdmin('auditSecurityNav') },
        { href: '/admin/moderation', label: tAdmin('moderationNav') },
      ],
    },
    {
    ...
    <div className="admin-shell min-h-screen lg:grid lg:grid-cols-[280px_1fr]">
      <aside className="admin-sidebar px-5 py-8">
        ...
        <div className="mt-10 rounded-xl border border-[var(--admin-gold-muted)] p-4">
          ...
          <p className="mt-3 text-xs text-[#c9a962]">
